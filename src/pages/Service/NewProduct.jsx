...
import { FaBoxes, FaTag, FaImage, FaArrowLeft } from "react-icons/fa";
...
const NewProduct = () => {
  ...
  // Sample categories for hospital management system
  ...
  const formFields = [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          options: formData.parentCategory ? subCategories[formData.parentCategory] : [],
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setFormData((prev) => ({
          ...prev,
          categoryLogo: file,
          categoryLogoPreview: reader.result,
        }));
      };
                      ...
                      {formData.categoryLogoPreview && (
                        <div className="mt-2">
                          ...
                          <div className="w-32 h-32 border border-gray-200 rounded-lg overflow-hidden">
                            <img
                              src={formData.categoryLogoPreview}
